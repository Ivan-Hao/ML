...
plt.title("Training precision and loss")
plt.xlabel("T")
plt.ylabel("value")
plt.legend(loc=0)
...
plt.plot(GD_train_error,'g-', label = "GD")
plt.plot(fix_error_SGD,'b-', label="SGD")
...
plt.plot(fix_SGD,'r-', label = "SGD accuracy")
...
#test GD and SGD and fSGD
plt.figure()
plt.plot(GD_test_error,'g-',label="GD" )
#plt.plot(S_test_error,'b-', label = "test SGD error")
plt.plot(f_test_error,'b-', label = "SGD")
plt.title("Eout GD and SGD")
plt.xlabel("T")
plt.ylabel("Eout")
plt.legend(loc=0)
plt.tick_params(axis='both', color='red')
